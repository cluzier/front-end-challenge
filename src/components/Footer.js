...
function Footer() {
    var renderer, scene, camera, planet, skelet;
    ...
    function init() {
        ...
        camera = new THREE.PerspectiveCamera(25, window.outerWidth / window.outerHeight, 1, 1000);
    ...
    return (
        <div className="Footer">
            <p>Created by <a href="https://github.com/cluzier">@cluzier</a> using Bitpay's <a href="https://bitpay.com/api/">API</a>.</p>
            <div id="canvas"></div>
        </div>
    );
}
